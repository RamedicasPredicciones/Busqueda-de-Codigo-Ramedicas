    ...
    for match, score, idx in matches:
        ...
        if client_terms.issubset(candidate_terms):
            if score > highest_score:
                highest_score = score
                best_match = {'nombre_cliente': client_name, 'nombre_ramedicas': candidate_row['nomart'], 'codart': candidate_row['codart'], 'score': score}
...
# Mostrar el logo
st.image("https://raw.githubusercontent.com/TU_USUARIO/TU_REPOSITORIO/main/Logo%20Ramedicas.png", use_column_width=False, width=200, output_format="PNG", caption="Ramédicas SAS", classes="logo")
